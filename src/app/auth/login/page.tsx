...
import { AuthProvider } from '@/providers/main-api/auth/auth.provider';
...
export default function LoginPg() {
	...
	const imgAddress =
		'https://plataforma-cf.s3.sa-east-1.amazonaws.com/c012145b-0cfa-4abe-b243-c6d8b4c19fd2.jpg';
	...
	return (
		<>
			<Typography
				...
				fontSize={{ xs: '40px', sm: '40px', md: '40px', lg: '60px' }}
				sx={{ lineHeight: '60px' }}
				fontWeight={600}
			>
			...
			>
				...
				<TextField
					...
					InputProps={{
						// Adicione esta propriedade para personalizar o input
						endAdornment: (
				...
				<Button
					...
					endIcon={
						isSubmitting ? <CircularProgress /> : <ArrowForwardRounded />
					}
					sx={{
						color: '#CCFD5D',
